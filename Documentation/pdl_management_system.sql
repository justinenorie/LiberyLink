...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2024 at 03:28 AM
...
INSERT INTO `appointment` (`username`, `pdl_first_name`, `pdl_last_name`, `appointment_date`, `appointment_time`) VALUES
('Test', '', '', '2024-05-25', '18:36:00'),
('Test', '', '', '2024-05-31', '01:39:00'),
('Test', '', '', '2024-05-31', '01:39:00'),
('Test', '', '', '2024-05-31', '01:49:00'),
('Test', '', '', '2024-05-31', '01:49:00'),
('Test', '', '', '2024-05-31', '01:54:00');
...
(1, 'Test', '2024-05-30', '10:53:00', 1, 'Liam', 'Johnson'),
(2, 'Test', '2024-05-18', '08:57:00', 1, 'Liam', 'Johnson'),
(3, 'Test', '2024-05-31', '10:54:00', 1, 'Liam', 'Johnson');
...
('001', 'Liam', 'Johnson', 'Active', 'Homicide', 'Male', '1970-01-01', '25 years', '0001'),
('002', 'Noah', 'Brown', 'Active', 'Robbery', 'Male', '1980-01-01', '10 years', '0001'),
('003', 'Oliver', 'Davis', 'Active', 'Fraud', 'Male', '1990-01-01', '7 years', '0001'),
('004', 'Elijah', 'Miller', 'Active', 'Assault', 'Male', '1995-01-01', '3 years', '0001'),
...
('Test', 'Test', 'Male', 'Test', 'Test', 'Test@gmail.com', 'Test'),
('Test1', 'Test1', 'Female', 'Test1', 'Test1', 'Test1@gmail.com', 'Test1');
...
ALTER TABLE `appointment`
  ADD CONSTRAINT `fk_username` FOREIGN KEY (`username`) REFERENCES `user_visitors` (`username`) ON DELETE CASCADE;
...
--
ALTER TABLE `pdl_list`
  ADD CONSTRAINT `fk_cellblock_id` FOREIGN KEY (`cellblock_id`) REFERENCES `cell_block_list` (`cellblock_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
